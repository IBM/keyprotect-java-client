...
public class KpUtilities {
        ...
        public static String createInstance(ResourceController service, String resourceGroup) {
                ...
                Response<ResourceInstance> response = service.createResourceInstance(createResourceInstanceOptions)
                                .execute();
        ...
        public static Response<Void> rotateKey(IbmKeyProtectApi testService, String testInstance, String keyId,
                        String payload) {
        ...
        public static Response<RegistrationWithTotalCount> getRegistrationsForInstance(IbmKeyProtectApi testService,
                ...
                // Invoke operation with valid options model
                Response<RegistrationWithTotalCount> response = testService
                                .getRegistrationsAllKeys(getRegistrationsAllKeysOptionsModel).execute();
        ...
        public static Response<GetKeyPoliciesOneOf> createKeyPolicyDualAuthDelete(IbmKeyProtectApi testService,
                ...
                // Construct an instance of the SetKeyPoliciesOneOfSetKeyPolicyDualAuthDelete
                // model
                SetKeyPoliciesOneOfSetKeyPolicyDualAuthDelete setKeyPoliciesOneOfDualAuthDeleteModel = new SetKeyPoliciesOneOfSetKeyPolicyDualAuthDelete.Builder()
                                .metadata(collectionMetadataModel)
                                .resources(new ArrayList<KeyPolicyDualAuthDelete>(
                                                Arrays.asList(keyPolicyDualAuthDeleteModel)))
                                .build();
                ...
                PutPolicyOptions putPolicyOptionsModel = new PutPolicyOptions.Builder()
                                .id(keyId)
                                .bluemixInstance(testInstance)
                                .keyPolicyPutBody(setKeyPoliciesOneOfDualAuthDeleteModel)
        ...
        public static Response<GetKeyPoliciesOneOf> createKeyPolicyRotation(IbmKeyProtectApi testService,
                ...
                SetKeyPoliciesOneOfSetKeyPolicyRotation setKeyPoliciesOneOfRotationModel = new SetKeyPoliciesOneOfSetKeyPolicyRotation.Builder()
                                .metadata(collectionMetadataModel)
                ...
                PutPolicyOptions putPolicyOptionsModel = new PutPolicyOptions.Builder()
                                .id(keyId)
                                .bluemixInstance(testInstance)
                                .keyPolicyPutBody(setKeyPoliciesOneOfRotationModel)
                                .policy("rotation")
                                .build();
        ...
        public static Response<Void> createInstancePolicyDualAuthDelete(IbmKeyProtectApi testService,
                ...
                // Construct an instance of the SetInstancePolicyDualAuthDeleteResourcesItem
                // model
                ...
                // SetInstancePoliciesOneOfSetInstancePolicyDualAuthDelete model
                SetInstancePoliciesOneOfSetInstancePolicyDualAuthDelete setInstancePoliciesOneOfDualAuthDeleteModel = new SetInstancePoliciesOneOfSetInstancePolicyDualAuthDelete.Builder()
                                .metadata(collectionMetadataModel)
                ...
                PutInstancePolicyOptions putInstancePolicyOptionsModel = new PutInstancePolicyOptions.Builder()
                                .bluemixInstance(testInstance)
                                .instancePolicyPutBody(setInstancePoliciesOneOfDualAuthDeleteModel)
                                .policy("dualAuthDelete")
                                .build();
        ...
        public static Response<Void> createInstancePolicyAllowedNetwork(IbmKeyProtectApi testService,
                ...
                // Construct an instance of the InstancePolicyAllowedNetworkPolicyDataAttributes
                // model
                ...
                // Construct an instance of the
                // SetInstancePoliciesOneOfSetInstancePolicyAllowedNetworkResourcesItem model
                ...
                // Construct an instance of the
                // SetInstancePoliciesOneOfSetInstancePolicyAllowedNetwork model
                SetInstancePoliciesOneOfSetInstancePolicyAllowedNetwork setInstancePoliciesOneOfAllowedNetworkModel = new SetInstancePoliciesOneOfSetInstancePolicyAllowedNetwork.Builder()
                                .metadata(collectionMetadataModel)
                ...
                PutInstancePolicyOptions putInstancePolicyOptionsModel = new PutInstancePolicyOptions.Builder()
                                .bluemixInstance(testInstance)
                                .instancePolicyPutBody(setInstancePoliciesOneOfAllowedNetworkModel)
        ...
        public static Response<Void> createInstancePolicyMetrics(IbmKeyProtectApi testService,
                ...
                // Construct an instance of the
                // SetInstancePoliciesOneOfSetInstancePolicyMetricsResourcesItem model
                ...
                // Construct an instance of the SetInstancePoliciesOneOfSetInstancePolicyMetrics
                // model
                SetInstancePoliciesOneOfSetInstancePolicyMetrics setInstancePoliciesOneOfMetricsModel = new SetInstancePoliciesOneOfSetInstancePolicyMetrics.Builder()
                                .metadata(collectionMetadataModel)
                ...
                PutInstancePolicyOptions putInstancePolicyOptionsModel = new PutInstancePolicyOptions.Builder()
                                .bluemixInstance(testInstance)
                                .instancePolicyPutBody(setInstancePoliciesOneOfMetricsModel)
                                .policy("metrics")
                                .build();
        ...
        public static Response<Void> createInstancePolicyKeyCreateImportAccess(IbmKeyProtectApi testService,
                ...
                // Construct an instance of the
                // InstancePolicyKeyCreateImportAccessPolicyDataAttributes model
                ...
                // Construct an instance of the InstancePolicyKeyCreateImportAccessPolicyData
                // model
                ...
                // Construct an instance of the
                // SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccess model
                SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccess setInstancePoliciesOneOfKeyCreateImportAccessModel = new SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccess.Builder()
                                .metadata(collectionMetadataModel)
                ...
                PutInstancePolicyOptions putInstancePolicyOptionsModel = new PutInstancePolicyOptions.Builder()
                                .bluemixInstance(testInstance)
                                .instancePolicyPutBody(setInstancePoliciesOneOfKeyCreateImportAccessModel)
        ...
        public static Response<GetInstancePoliciesOneOf> getInstancePolicies(IbmKeyProtectApi testService,
                ...
                // Invoke operation with valid options model
                Response<GetInstancePoliciesOneOf> response = testService
                                .getInstancePolicy(getInstancePolicyOptionsModel).execute();
        ...
        // API docs: https://cloud.ibm.com/apidocs/key-protect
        public static Response<ListKeyRingsWithTotalCount> getKeyRings(IbmKeyProtectApi testService,
                        String testInstance) {
        ...
        public static ListKMIPAdaptersWithTotalCount listKmipAdapters(IbmKeyProtectApi testService, String testInstance,
                        long limit, long offset, boolean totalCount) {
                // Build Request
                GetKmipAdaptersOptions.Builder getKmipAdaptersModelBuilder = new GetKmipAdaptersOptions.Builder()
                                .bluemixInstance(testInstance)
                                .limit(limit)
                                .offset(offset)
                                .totalCount(totalCount);
                // Leaving room for filters.
                GetKmipAdaptersOptions getKmipAdaptersModel = getKmipAdaptersModelBuilder.build();
                // execute API Call
                Response<ListKMIPAdaptersWithTotalCount> response = testService.getKmipAdapters(getKmipAdaptersModel).execute();
                return response.getResult();
        }

        public static KMIPAdapter createKmipAdapterNative(IbmKeyProtectApi testService, String testInstance,
                        String crkId, String adapterName, String adapterDesc) {

                // Build Request
                CreateKmipAdapterOptions createKmipAdapterModel = buildCreateKmipAdapterNative(testInstance, crkId, adapterName, adapterDesc);

                // execute API Call
                Response<ListKMIPAdapters> response = testService.createKmipAdapter(createKmipAdapterModel).execute();
                KMIPAdapter adapter = response.getResult().getResources().get(0);
                return adapter;
        }

        public static KMIPAdapter getKmipAdapter(IbmKeyProtectApi testService, String testInstance,
                        String adapterNameOrID) {
                // Build Request
                GetKmipAdapterOptions getKmipAdapterModel = new GetKmipAdapterOptions.Builder()
                                .bluemixInstance(testInstance)
                                .id(adapterNameOrID)
                                .build();
                // execute API Call
                Response<ListKMIPAdapters> response = testService.getKmipAdapter(getKmipAdapterModel).execute();
                KMIPAdapter adapter = response.getResult().getResources().get(0);
                return adapter;
        }

        public static Response<Void> deleteKmipAdapter(IbmKeyProtectApi testService, String testInstance,
                        String adapterNameOrID) {
                // Build Request
                DeleteKmipAdapterOptions deleteKmipAdapterModel = new DeleteKmipAdapterOptions.Builder()
                                .bluemixInstance(testInstance)
                                .id(adapterNameOrID)
                                .build();
                // execute API Call
                Response<Void> response = testService.deleteKmipAdapter(deleteKmipAdapterModel).execute();
                return response;
        }

        public static ListKMIPPartialClientCertificatesWithTotalCount listKMIPClientCertificates(
                        IbmKeyProtectApi testService, String testInstance,
                        String adapterNameOrID, long limit, long offset, boolean totalCount) {
                // Build Request
                GetKmipClientCertificatesOptions opts = new GetKmipClientCertificatesOptions.Builder()
                                .bluemixInstance(testInstance)
                                .limit(limit)
                                .offset(offset)
                                .totalCount(totalCount)
                                .build();
                // Execute response
                Response<ListKMIPPartialClientCertificatesWithTotalCount> response = testService
                                .getKmipClientCertificates(opts).execute();
                return response.getResult();
        }

        public static KMIPClientCertificate addKmipClientCertificate(IbmKeyProtectApi testService, String testInstance,
                        String adapterNameOrID, String certPayload, String certName) {
                
                // Build Request
                AddKmipClientCertificateOptions opts = buildAddKmipCertOpts(testInstance, adapterNameOrID, certName, certPayload);
                // Execute Request
                Response<ListKMIPClientCertificates> response = testService.addKmipClientCertificate(opts).execute();
                KMIPClientCertificate cert = response.getResult().getResources().get(0);
                return cert;
        }

        public static KMIPClientCertificate getKmipClientCertificate(IbmKeyProtectApi testService, String testInstance,
                        String adapterNameOrID, String certNameOrID) {
                // Build Request
                GetKmipClientCertificateOptions opts = new GetKmipClientCertificateOptions.Builder()
                                .bluemixInstance(testInstance)
                                .adapterId(adapterNameOrID)
                                .id(certNameOrID)
                                .build();
                // Execute Request
                Response<ListKMIPClientCertificates> response = testService.getKmipClientCertificate(opts).execute();
                KMIPClientCertificate cert = response.getResult().getResources().get(0);
                return cert;
        }

        public static Response<Void> deleteKmipClientCertificate(IbmKeyProtectApi testService, String testInstance,
                        String adapterNameOrID, String certNameOrID) {
                // Build Request
                DeleteKmipClientCertificateOptions opts = new DeleteKmipClientCertificateOptions.Builder()
                                .bluemixInstance(testInstance)
                                .adapterId(adapterNameOrID)
                                .id(certNameOrID)
                                .build();
                // Execute Request
                Response<Void> response = testService.deleteKmipClientCertificate(opts).execute();
                return response;
        }
        ...
        public static CreateKmipAdapterOptions buildCreateKmipAdapterNative(String testInstance, String crkID,
        String adapterName, String description){
                CreateKMIPAdapterRequestBodyResources.Builder adapterBuilder = new CreateKMIPAdapterRequestBodyResources.Builder()
                        .profile(CreateKMIPAdapterRequestBodyResources.Profile.NATIVE_1_0)
                        .profileData(new KMIPProfileDataBodyKMIPProfileDataNative.Builder()
                                .crkId(crkID)
                                .build()
                        );
                if (adapterName != null) {
                        adapterBuilder.name(adapterName);
                }
                if (description != null) {
                        adapterBuilder.description(description);
                }
                
                CreateKmipAdapterOptions opts = new CreateKmipAdapterOptions.Builder()
                        .bluemixInstance(testInstance)
                        .metadata(buildCollectionOfTypeOne(CollectionMetadata.CollectionType.APPLICATION_VND_IBM_KMS_KMIP_ADAPTER_JSON))
                        .addResources(adapterBuilder.build())
                        .build();
                return opts;
        }

        public static AddKmipClientCertificateOptions buildAddKmipCertOpts(String testInstance, String adapterNameOrID, String certName, String certPayload){
                CreateKMIPClientCertificateObject.Builder certBuilder = new CreateKMIPClientCertificateObject.Builder().certificate(certPayload);
                if (certName != null) {
                        certBuilder.name(certName);
                }
                CreateKMIPClientCertificateObject cert = certBuilder.build();

                AddKmipClientCertificateOptions opts = new AddKmipClientCertificateOptions.Builder()
                        .bluemixInstance(testInstance)
                        .adapterId(adapterNameOrID)
                        .metadata(buildCollectionOfTypeOne(CollectionMetadata.CollectionType.APPLICATION_VND_IBM_KMS_KMIP_CLIENT_CERTIFICATE_JSON))
                        .addResources(cert)
                        .build();
                return opts;
        }

        public static CollectionMetadata buildCollectionOfTypeOne (String type) {
                return new CollectionMetadata.Builder().collectionType(type).collectionTotal(1).build();
        }
}