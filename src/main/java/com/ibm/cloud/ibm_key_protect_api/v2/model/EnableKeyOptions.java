...
/**
 * The enableKey options.
 */
public class EnableKeyOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(EnableKeyOptions enableKeyOptions) {
      ...
      this.correlationId = enableKeyOptions.correlationId;
      this.xKmsKeyRing = enableKeyOptions.xKmsKeyRing;
    }
     ...
     *
     * @return the new EnableKeyOptions instance
     */
    public EnableKeyOptions build() {
      return new EnableKeyOptions(this);
    }
     ...
     *
     * @param id the id
     * @return the EnableKeyOptions builder
     */
   ...
   * New builder.
   *
   * @return a EnableKeyOptions builder
   */
