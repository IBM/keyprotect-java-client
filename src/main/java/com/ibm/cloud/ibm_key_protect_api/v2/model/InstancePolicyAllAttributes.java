...
/**
 * All possible attributes for any instance policy type. Must be provided if the `enabled` field is `true`. Cannot be
 * provided if the `enabled` field is `false`.
 */
public class InstancePolicyAllAttributes extends GenericModel {
  ...
  protected InstancePolicyAllAttributes() { }
