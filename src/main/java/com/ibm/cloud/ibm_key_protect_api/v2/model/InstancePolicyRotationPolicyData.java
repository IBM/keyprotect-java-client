...
public class InstancePolicyRotationPolicyData extends GenericModel {
  ...
  public static class Builder {
     ...
     *
     * @param instancePolicyRotationPolicyData the instance to initialize the Builder with
     */
    private Builder(InstancePolicyRotationPolicyData instancePolicyRotationPolicyData) {
      this.enabled = instancePolicyRotationPolicyData.enabled;
      this.attributes = instancePolicyRotationPolicyData.attributes;
    }
    ...
    /**
     * Builds a InstancePolicyRotationPolicyData.
     *
     * @return the new InstancePolicyRotationPolicyData instance
     */
    public InstancePolicyRotationPolicyData build() {
      return new InstancePolicyRotationPolicyData(this);
    }
  ...
  protected InstancePolicyRotationPolicyData() { }

  protected InstancePolicyRotationPolicyData(Builder builder) {
   ...
   * New builder.
   *
   * @return a InstancePolicyRotationPolicyData builder
   */
   ...
   * Gets the attributes.
   *
   * Attributes of a `rotation` instance policy. Must be provided if the `enabled` field is `true`. Cannot be provided
