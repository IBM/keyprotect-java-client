...
/**
 * Properties that are associated with an allowed network policy.
 */
public class InstancePolicyResourceAllowedNetworkPolicy extends GenericModel {
  ...
  protected NetworkPolicyProperties policyData;
