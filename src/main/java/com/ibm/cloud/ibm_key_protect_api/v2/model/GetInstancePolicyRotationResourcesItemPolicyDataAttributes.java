 ...
 */
public class GetInstancePolicyRotationResourcesItemPolicyDataAttributes extends GenericModel {

  @SerializedName("interval_month")
  protected Long intervalMonth;

  protected GetInstancePolicyRotationResourcesItemPolicyDataAttributes() { }
