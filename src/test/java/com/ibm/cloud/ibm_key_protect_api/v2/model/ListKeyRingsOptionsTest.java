...
/**
 * Unit test class for the ListKeyRingsOptions model.
 */
public class ListKeyRingsOptionsTest {
  ...
  public void testListKeyRingsOptionsError() throws Throwable {
    new ListKeyRingsOptions.Builder().build();
  }
