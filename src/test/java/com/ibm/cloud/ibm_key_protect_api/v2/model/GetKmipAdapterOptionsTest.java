...
/**
 * Unit test class for the GetKmipAdapterOptions model.
 */
public class GetKmipAdapterOptionsTest {
  ...
  public void testGetKmipAdapterOptionsError() throws Throwable {
    new GetKmipAdapterOptions.Builder().build();
  }
