...
/**
 * Unit test class for the GetKeyPoliciesOneOf model.
 */
public class GetKeyPoliciesOneOfTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testGetKeyPoliciesOneOf() throws Throwable {
    GetKeyPoliciesOneOf getKeyPoliciesOneOfModel = new GetKeyPoliciesOneOf();
    assertNotNull(getKeyPoliciesOneOfModel);
  }
}