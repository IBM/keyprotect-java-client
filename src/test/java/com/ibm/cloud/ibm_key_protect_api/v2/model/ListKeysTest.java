...
/**
 * Unit test class for the ListKeys model.
 */
public class ListKeysTest {
  ...
  @Test
  public void testListKeys() throws Throwable {
    ListKeys listKeysModel = new ListKeys();
    assertNull(listKeysModel.getMetadata());
    assertNull(listKeysModel.getResources());
  }
}