...
/**
 * Unit test class for the DeleteKmipAdapterOptions model.
 */
public class DeleteKmipAdapterOptionsTest {
  ...
  public void testDeleteKmipAdapterOptionsError() throws Throwable {
    new DeleteKmipAdapterOptions.Builder().build();
  }
