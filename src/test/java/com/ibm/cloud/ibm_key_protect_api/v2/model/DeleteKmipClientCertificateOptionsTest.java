...
/**
 * Unit test class for the DeleteKmipClientCertificateOptions model.
 */
public class DeleteKmipClientCertificateOptionsTest {
  ...
  public void testDeleteKmipClientCertificateOptionsError() throws Throwable {
    new DeleteKmipClientCertificateOptions.Builder().build();
  }
