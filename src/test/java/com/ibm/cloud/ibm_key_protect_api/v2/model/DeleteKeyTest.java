...
/**
 * Unit test class for the DeleteKey model.
 */
public class DeleteKeyTest {
  ...
  public void testDeleteKey() throws Throwable {
    DeleteKey deleteKeyModel = new DeleteKey();
    assertNull(deleteKeyModel.getMetadata());
    assertNull(deleteKeyModel.getResources());
  }
}