...
public class GetKeyCollectionMetadataOptionsTest {
  ...
  public void testGetKeyCollectionMetadataOptions() throws Throwable {
    ...
    assertEquals(getKeyCollectionMetadataOptionsModel.state(), java.util.Arrays.asList(Long.valueOf("0"), Long.valueOf("1"), Long.valueOf("2"), Long.valueOf("3")));
    assertEquals(getKeyCollectionMetadataOptionsModel.extractable(), Boolean.valueOf(true));
    assertEquals(getKeyCollectionMetadataOptionsModel.filter(), "testString");
