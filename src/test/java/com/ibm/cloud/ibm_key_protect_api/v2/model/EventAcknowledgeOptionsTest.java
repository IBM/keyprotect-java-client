...
/**
 * Unit test class for the EventAcknowledgeOptions model.
 */
public class EventAcknowledgeOptionsTest {
  ...
  public void testEventAcknowledgeOptionsError() throws Throwable {
    new EventAcknowledgeOptions.Builder().build();
  }
