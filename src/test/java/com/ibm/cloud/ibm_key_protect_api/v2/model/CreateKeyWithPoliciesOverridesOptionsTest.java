...
/**
 * Unit test class for the CreateKeyWithPoliciesOverridesOptions model.
 */
public class CreateKeyWithPoliciesOverridesOptionsTest {
  ...
  public void testCreateKeyWithPoliciesOverridesOptionsError() throws Throwable {
    new CreateKeyWithPoliciesOverridesOptions.Builder().build();
  }
