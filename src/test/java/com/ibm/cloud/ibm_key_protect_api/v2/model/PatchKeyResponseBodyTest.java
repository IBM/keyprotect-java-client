 ...
 */
public class PatchKeyResponseBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPatchKeyResponseBody() throws Throwable {
    PatchKeyResponseBody patchKeyResponseBodyModel = new PatchKeyResponseBody();
    assertNull(patchKeyResponseBodyModel.getMetadata());
    assertNull(patchKeyResponseBodyModel.getResources());
  }
}