...
/**
 * Unit test class for the RestoreKeyOptions model.
 */
public class RestoreKeyOptionsTest {
  ...
  public void testRestoreKeyOptionsError() throws Throwable {
    new RestoreKeyOptions.Builder().build();
  }
