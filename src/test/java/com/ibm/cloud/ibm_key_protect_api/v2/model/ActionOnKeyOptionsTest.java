...
/**
 * Unit test class for the ActionOnKeyOptions model.
 */
public class ActionOnKeyOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testActionOnKeyOptions() throws Throwable {
  ...
  public void testActionOnKeyOptionsError() throws Throwable {
    new ActionOnKeyOptions.Builder().build();
  }
