...
/**
 * Unit test class for the ListKMIPAdapters model.
 */
public class ListKMIPAdaptersTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListKMIPAdapters() throws Throwable {
    ListKMIPAdapters listKmipAdaptersModel = new ListKMIPAdapters();
    assertNull(listKmipAdaptersModel.getMetadata());
    assertNull(listKmipAdaptersModel.getResources());
  }
}