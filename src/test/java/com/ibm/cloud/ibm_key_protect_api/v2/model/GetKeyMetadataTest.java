...
/**
 * Unit test class for the GetKeyMetadata model.
 */
public class GetKeyMetadataTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetKeyMetadata() throws Throwable {
    GetKeyMetadata getKeyMetadataModel = new GetKeyMetadata();
    assertNull(getKeyMetadataModel.getMetadata());
    assertNull(getKeyMetadataModel.getResources());
  }
}