...
public class ImportTokenTest {
  ...
  public void testImportToken() throws Throwable {
    ImportToken importTokenModel = new ImportToken.Builder()
      ...
      .build();
    assertEquals(importTokenModel.expiration(), Double.valueOf("72.5"));
    assertEquals(importTokenModel.maxAllowedRetrievals(), Double.valueOf("72.5"));
    ...
    assertEquals(importTokenModelNew.expiration(), Double.valueOf("72.5"));
    assertEquals(importTokenModelNew.maxAllowedRetrievals(), Double.valueOf("72.5"));
  }
}